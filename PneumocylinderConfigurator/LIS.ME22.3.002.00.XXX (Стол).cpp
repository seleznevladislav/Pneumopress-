...
double aXXX = 200.0;//длина
double bXXX = 165.0;//ширина
double cXXX = 16.0;//высота
double raznXXX = 200 / 8; //=25
double rXXX = 10.0;//радиус центрального отверстия
...
SPtr<MbSolid> ParametricModelCreator::LIS_ME22_3_002_00_XXX()
{
    MbSolid* pPrism = nullptr;
    {
        ...
        const double HEIGHT_FORWARD1 = cXXX, HEIGHT_BACKWARD1 = 0;
    ...
    ::ElementarySolid(cylPnts5, et_Cylinder, namesElSolid, pCyl_Solid5);
    ...
    //центральное
    MbSolid* pSolid = NULL;
    ::BooleanResult(*pPrism, cm_Copy, *pCyl, cm_Copy, bo_Difference, flagsBool, operBoolNames, pSolid);
    ...
    MbSolid* pBlock = nullptr;
    {
        ...
        points.Add(MbCartPoint3D(-102.1 + 31, 16, -84.65 + 28 + 10));//центр СК//128-25.9=102.1 160-75.35=84.65
        points.Add(MbCartPoint3D(-102.11 + 167, 16, -84.65 + 28 + 10));//ось X
        points.Add(MbCartPoint3D(-102.1 + 167, 16, -84.65 + 38 + 10));//осьY
        points.Add(MbCartPoint3D(-102.1 + 31, 11, -84.65 + 3 + 10));//высота
    ...
    pBlock->GetEdges(allEdgesB);

    RPArray<MbCurveEdge> initCurvesB(4, 1);
    initCurvesB.Add(allEdgesB[8]);
    initCurvesB.Add(allEdgesB[9]);
    initCurvesB.Add(allEdgesB[10]);
    initCurvesB.Add(allEdgesB[11]);

    RPArray<MbFace> initBoundsB(0, 1);

    ::FilletSolid(*pBlock, cm_Copy, initCurvesB, initBoundsB, paramsB, filletNames, pBlock);
    ...
    MbSolid* pBlock1 = nullptr;
    {
        MbSNameMaker names(1, MbSNameMaker::i_SideNone, 0);
        SArray<MbCartPoint3D> points(4);
        points.Add(MbCartPoint3D(-102.1 + 31, 16, -84.65 + 28 + 10 + 22));//центр СК//128-25.9=102.1 160-75.35=84.65
        points.Add(MbCartPoint3D(-102.11 + 167, 16, -84.65 + 28 + 10 + 22));//ось X
        points.Add(MbCartPoint3D(-102.1 + 167, 16, -84.65 + 38 + 10 + 22));//осьY
        points.Add(MbCartPoint3D(-102.1 + 31, 11, -84.65 + 3 + 10 + 22));//высота
        ::ElementarySolid(points, et_Block, names, pBlock1);
    }

    RPArray<MbCurveEdge> allEdgesB1(4, 1);
    pBlock1->GetEdges(allEdgesB1);
    RPArray<MbCurveEdge> initCurvesB1(4, 1);
    initCurvesB1.Add(allEdgesB1[8]);
    initCurvesB1.Add(allEdgesB1[9]);
    initCurvesB1.Add(allEdgesB1[10]);
    initCurvesB1.Add(allEdgesB1[11]);

    RPArray<MbFace> initBoundsB1(0, 1);

    ::FilletSolid(*pBlock1, cm_Copy, initCurvesB1, initBoundsB1, paramsB, filletNames, pBlock1);

    ::BooleanResult(*pSolid, cm_Copy, *pBlock, cm_Copy, bo_Difference, flagsBool, operBoolNames, pSolid);
    ::BooleanResult(*pSolid, cm_Copy, *pBlock1, cm_Copy, bo_Difference, flagsBool, operBoolNames, pSolid);

    MbSolid* pBlock_ = NULL;
    MbSolid* pBlock1_ = NULL;

    ::MirrorSolid(*pBlock, VerticalPlane4, operNames, pBlock_);
    ::MirrorSolid(*pBlock1, VerticalPlane4, operNames, pBlock1_);
    ::BooleanResult(*pSolid, cm_Copy, *pBlock_, cm_Copy, bo_Difference, flagsBool, operBoolNames, pSolid);
    ::BooleanResult(*pSolid, cm_Copy, *pBlock1_, cm_Copy, bo_Difference, flagsBool, operBoolNames, pSolid);
